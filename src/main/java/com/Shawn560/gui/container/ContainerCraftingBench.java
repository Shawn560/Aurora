package com.Shawn560.gui.container;
...
import com.Shawn560.crafting.CraftingBenchCraftingManager;
...
public class ContainerCraftingBench extends Container {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, CraftingBenchCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != MBlocks.CraftingBench) {
			return false;
		}else{

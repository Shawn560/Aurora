...
public class EntityBatman extends EntityVillager {

	public EntityBatman(EntityPlayer player, World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.AQUA+"GoddamnBatman");
	}

	public EntityBatman createChild(EntityAgeable p_90011_1_)
    {
		return null;

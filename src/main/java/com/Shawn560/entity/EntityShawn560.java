...
public class EntityShawn560 extends EntityVillager {

	public EntityShawn560(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.BLUE+"Shawn560");
        this.setProfession(0);
	}
	
	public EntityShawn560 createChild(EntityAgeable p_90011_1_)
    {
		return null;
		
    }
	
	public Object interact(World world, int x, int y, int z, EntityPlayer p, int side, float hitX, float hitY, float hitZ)
	{
		return false;
	}

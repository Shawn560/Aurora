...
public class EntityNathmatt25 extends EntityVillager {

	public EntityNathmatt25(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.DARK_RED+"Nathmatt25");

	}
	
	public EntityNathmatt25 createChild(EntityAgeable p_90011_1_)
    {
		return null;

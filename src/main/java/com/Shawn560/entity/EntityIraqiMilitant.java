...
public class EntityIraqiMilitant extends EntityVillager {

	public EntityIraqiMilitant(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.LIGHT_PURPLE+"IraqiMilitant");
	}
	
	public EntityIraqiMilitant createChild(EntityAgeable p_90011_1_)
    {
		return null;

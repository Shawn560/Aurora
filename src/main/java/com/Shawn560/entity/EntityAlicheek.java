...
public class EntityAlicheek extends EntityVillager {

	public EntityAlicheek(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.DARK_PURPLE+"Alicheek");
    
	}
	
	public EntityAlicheek createChild(EntityAgeable p_90011_1_)
    {
		return null;

...
public class EntityBackcab extends EntityVillager {

	public EntityBackcab(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.YELLOW+"Backcab");
	}
	
	public EntityBackcab createChild(EntityAgeable p_90011_1_)
    {
		return null;

...
public class EntityMadjock999 extends EntityVillager {

	public EntityMadjock999(World world) {
		super(world);
        ...
        this.setCustomNameTag(EnumChatFormatting.GREEN+"Madjock999");
	}
	
	public EntityMadjock999 createChild(EntityAgeable p_90011_1_)
    {
		return null;

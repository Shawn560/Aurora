...
public class CraftingBenchShapedRecipes implements IRecipe
{
    ...
    public CraftingBenchShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public CraftingBenchShapedRecipes func_92100_c()
    {
